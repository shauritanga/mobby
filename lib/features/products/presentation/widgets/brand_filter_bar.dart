  ...
  Widget _buildBrandQuickFilters(BuildContext context, WidgetRef ref) {
    ...
    final quickFilters = [
      BrandQuickFilter(
        ...
        () {
          ref
              ...
              .updateSortBy(SortOption.popular);
          onFilterChanged?.call();
        },
      ...
      BrandQuickFilter('New Arrivals', Icons.fiber_new, () {
        ref.read(filterStateProvider.notifier).updateSortBy(SortOption.newest);
        onFilterChanged?.call();
      }, currentFilter.sortBy == SortOption.newest),
      ...
      BrandQuickFilter('Top Rated', Icons.star, () {
...
class BrandQuickFilter {
  final String label;
  final IconData icon;
  final VoidCallback onTap;
  final bool isSelected;

  BrandQuickFilter(this.label, this.icon, this.onTap, this.isSelected);
}

// TODO: Implement BrandCategoryFilter when brand-category relationship is established
// class BrandCategoryFilter extends ConsumerWidget {
//   final String brandId;
...
//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
//     // This would need to fetch categories that have products from this brand
//     // rather than accessing brand.categories which doesn't exist
//     return const SizedBox.shrink();
//   }
// }

// View mode provider (reused from category filter bar)
