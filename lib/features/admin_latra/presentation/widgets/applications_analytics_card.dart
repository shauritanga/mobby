...
class ApplicationsAnalyticsCard extends ConsumerWidget {
  const ApplicationsAnalyticsCard({super.key});
  ...
  Widget _buildAnalyticsContent(BuildContext context, Map<String, dynamic> analytics) {
    ...
    final processingApplications = analytics['processingApplications'] as int? ?? 0;
    ...
    return Column(
      children: [
        ...
        // Second row: Processing and Approved
        Row(
          children: [
            Expanded(
              child: _buildMetricItem(
                context,
                'Processing',
                processingApplications.toString(),
                Icons.settings,
                Colors.purple,
              ),
            ),
