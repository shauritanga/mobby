...
class NotificationsFeature {
  ...
  static const String description = 'Comprehensive notification and communication management system';
  ...
  static const List<NotificationChannel> supportedChannels = NotificationChannel.values;
