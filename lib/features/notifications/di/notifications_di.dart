...
final campaignsRemoteDataSourceProvider = Provider<CampaignsRemoteDataSource>((ref) {
  final firestore = ref.watch(firebaseFirestoreProvider);
...
final markAllNotificationsAsReadProvider = Provider<MarkAllNotificationsAsRead>((ref) {
  final repository = ref.watch(notificationsRepositoryProvider);
...
final sendNotificationStateProvider = StateNotifierProvider<SendNotificationNotifier, SendNotificationState>((ref) {
...
final templateEditorProvider = StateNotifierProvider<TemplateEditorNotifier, TemplateEditorState>((ref) {
...
final notificationStatsProvider = FutureProvider.family<Map<String, int>, String>((ref, userId) async {
...
final templatesByTypeProvider = FutureProvider.family<List<Template>, TemplateType>((ref, type) async {
  final getTemplatesByType = ref.watch(getTemplatesByTypeProvider);
  final result = await getTemplatesByType(GetTemplatesByTypeParams(type: type));
